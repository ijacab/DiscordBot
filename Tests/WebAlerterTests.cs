...
namespace Tests
{
    public class WebAlterterTests
    {
        ...
        public async Task Test1()
        {
            ...
            settings.UserName = EnvironmentHelper.GetEnvironmentVariable("GITHUB_USERNAME");
            settings.Id = EnvironmentHelper.GetEnvironmentVariable("GITHUB_GIST_ID");
            ...
            using (var httpClient = new HttpClient())
            {
                ...
                httpClient.DefaultRequestHeaders.Add("Authorization", $"token { EnvironmentHelper.GetEnvironmentVariable("GITHUB_PAT_TOKEN")}");
