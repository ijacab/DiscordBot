...
namespace DiscordBot.Managers
{
    public partial class CommandManager
    {
            ...
            BlackjackManager blackjackManager, BetManager betManager, BattleArenaManager battleArenaManager)
        {
            ...
            _commands.Add(new Command("faceoff", GameFaceOff) { RequiresAdmin = true, Description = "Plays a multiplayer faceoff game using virtual money. Type '.leaderboard' to see how much money you have", Syntax = "`.fo betAmount` to start where betAmount is the amount you want to bet. For example `.fo 1000`" });
            _commands.Add(new Command("fo", GameFaceOff) { RequiresAdmin = true, Hidden = true, Syntax = "`.fo betAmount` to start where betAmount is the amount you want to bet. For example `.fo 1000`" });
